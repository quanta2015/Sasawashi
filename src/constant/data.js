...
export const ABOUT_CONCEPT =[
    ...
    {
        "content":"本当に良いと思ったものは、 いつまでも使い続けたいもの。"  },
    {
        "content":"身に着けたとき、使うときの 心地よさや自然な感じを、何より大切にして生まれたデザインだから、とてもシンプル。よりよく改良することはあっても、「変わらない」。"  },
    {
        "content":"私たちがめざすのは、そんな真撃なものづくりです。"  },
]
...
export const ABOUT_WASHIKUMAZASA =[
{
    "title" : "和紙のこと", 
    "content" : "世界の紙の中で、和紙ほど生活に役立ってきた紙はないでしょう。和紙は洋紙に比べて粘り強く、耐水性、加工性に富み、独特の美しさに満ちています。 たとえば和室の障子。一枚の和紙が持つ調湿、吸水力、断熱性、UVカット力のおかげで、高温多湿の夏を涼しく、冬は暖かく過ごすことができるのです。 和紙はまた、あぶらとり紙や天ぷらの油切り紙としても使われるように、水だけでなく油もすっと吸収します。性質の異なる水と油を同時に吸収するこの機能は、「ささ和紙」のソックスやタオル類で実感いただけることでしょう。",
    "img" : "https://gigaplus.makeshop.jp/sasawashi/img/about/washi.jpg"  },
{
    "title" : "くまざさのこと", 
    "content" : "くまざさ（隈笹）は、世界でも日本の高冷地に群生するイネ科の植物。生命力が強く、雪の中でも青々と越年して、ほぼ60年間枯れずに成長します。 古くから強い抗菌作用で知られ、笹寿司、笹団子、ちまきなど食品の保存に用いられてきました。冬眠前のクマが、餌と共に大量に食べるのも、くまざさの強い血液浄化作用や解毒作用で長い冬眠中のからだを守るためといわれます。 近年、くまざさの持つ葉緑素や多糖体、リグニン、食物繊維、ビタミンK、その他豊富な有効成分が解明されてきました。効能・作用も多様ですが、「ささ和紙」製品は、特にその抗菌作用に着目して、生活用品に“そのまま”生かしたものです。", 
    "img" : "https://gigaplus.makeshop.jp/sasawashi/img/about/kumazasa.jpg"  }
]